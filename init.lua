...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- ChatGPT: add this for Nanvix formatting compatibility:
      -- Disable LSP formatting (we use external formatters via conform.nvim)
...
-- ChatGPT: So Neovim recognizes odin files.
vim.filetype.add {
  extension = {
    odin = 'odin',
  },
